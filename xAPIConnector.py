...
def loginCommand(userId, password, appId='', appName='', wrapperType=WRAPPER_NAME, wrapperVersion=WRAPPER_VERSION):
    return baseCommand('login', dict(userId=userId, password=password, appId=appId, appName=appName, wrapperType=wrapperType, wrapperVersion=wrapperVersion))
